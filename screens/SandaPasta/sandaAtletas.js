...
const atletas = [
  { name: 'Bernardo Estevão',
    idade: 33, 
    foto: require('../../img/atletas/bernardoprincipal.jpg'),
    associacao: 'YMAA',
    peso: '75/80',
    altura: 1.79,
    vitorias: 15,
  ...
  { name: 'Débora Bandeirinha',
    idade: 18, 
    foto: require('../../img/atletas/debora.jpg'),
    associacao: 'YMAA',
    peso: '60/65',
    altura: 1.59,
    vitorias: 5,
  ...
  { name: 'Diogo Rodrigues', 
    idade: 35, 
    foto: require('../../img/atletas/Diogo2.jpg'),
    associacao: 'YMAA',
    peso: 70,
    altura: 1.73,
    vitorias: 57,
  ...
  { name: 'Weronika Tatara', 
    idade: 29, 
    foto: require('../../img/atletas/weronika.jpg'),
    associacao: 'YMAA',
    peso: '60/65',
    altura: 1.69,
    vitorias: 8,
