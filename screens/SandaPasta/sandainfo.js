      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <View style={styles.card}>
          ...
          <Text style={styles.text}>
            Sanda, também conhecido como Sanshou, é uma forma moderna de combate corpo a corpo, esporte de combate e sistema de autodefesa desenvolvido pela República Popular da China. Sanda é derivado do Kung Fu tradicional e incorpora técnicas de várias artes marciais chinesas. Foi introduzido como um esporte competitivo na década de 1970.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.text}>
            O Sanda foi introduzido em Portugal no início dos anos 1990. Desde então, tem ganhado popularidade como um esporte competitivo e uma forma eficaz de autodefesa. Várias academias e associações promovem a prática do Sanda em todo o país.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.text}>
            O Sanda é praticado em um leitai, uma plataforma elevada que pode variar em altura e tamanho. Inclui uma combinação de socos, chutes, quedas e projeções. Os praticantes usam luvas, protetores de cabeça e outras proteções para garantir a segurança durante os combates. As sessões de treino geralmente incluem exercícios de condicionamento físico, técnicas de combate e sparring.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.text}>
            ...
            {'\n'}- Os combates são divididos em rounds de dois a três minutos.
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.text}>
            Para praticar Sanda, é recomendável encontrar uma academia ou instrutor qualificado. A prática inclui condicionamento físico, aprendizagem de técnicas de combate e prática regular de sparring. Competir em torneios é uma excelente forma de testar habilidades e ganhar experiência.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.text}>
            - Soco Limpo (Punho Fechado): 1 ponto
            {'\n'}- Chute Limpo (Pé ou Perna): 2 pontos
            {'\n'}
          </Text>
          <Text style={styles.subtitulo}>Quedas e Projeções</Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.text}>
          - Manter o controle do leitai e forçar o oponente a sair da plataforma: 1 ponto
          {'\n'}- Derrubar o oponente fora do leitai: 2 pontos{'\n'}
          </Text>
          ...
          {'\n'}- Se um lutador sair do leitai sem ser forçado: 1 ponto é deduzido.
          {'\n'}
          </Text>
